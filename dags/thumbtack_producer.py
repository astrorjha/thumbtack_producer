...
- **Connection ID:** `aws_fe_srvc_account` (Requires S3 write permissions).
...
ZIP_CODES = [
    ...
    "11201",
    "02108",
    "19103",  # Northeast (NYC, Boston, Philly)
    "30303",
    "33130",
    "20001",
    "28202",
    "37201",  # South (Atlanta, Miami, DC, Charlotte, Nashville)
    "60601",
    "48226",
    "55401",
    "63101",
    "43215",  # Midwest (Chicago, Detroit, Indy, St. Louis, Columbus)
    "75201",
    "77002",
    "78701",
    "80202",
    "85004",  # Southwest/Mountain (Dallas, Houston, Austin, Denver, Phoenix)
    "94105",
    "90012",
    "98101",
    "97201",
    "92101",  # West Coast (SF, LA, Seattle, Portland, San Diego)
]
...
def thumbtack_step0_producer():
        ...
        data = [
            {
                ...
                "property_type": random.choice(
                    ["house", "townhouse", "apartment", "condo", "commercial"]
                ),
                "urgency": random.choice(
                    ["flexible", "within_48_hours", "within_a_week", "asap"]
                ),
            }
    ...
    simulate_user_traffic(bucket_name=S3_BUCKET)


thumbtack_step0_producer()
